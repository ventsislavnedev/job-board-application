        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Location = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: false),
                    Salary_AmountMin = table.Column<decimal>(type: "numeric", nullable: true),
                    Salary_AmountMax = table.Column<decimal>(type: "numeric", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_JobPostingTechnologies", x => new { x.JobPostingId, x.TechnologyId });
                    table.ForeignKey(
                        name: "FK_JobPostingTechnologies_JobPostings_JobPostingId",
                        column: x => x.JobPostingId,
                        principalTable: "JobPostings",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_JobPostingTechnologies_Technologies_TechnologyId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_JobPostingTechnologies_TechnologyId",
                table: "JobPostingTechnologies",
                column: "TechnologyId");
